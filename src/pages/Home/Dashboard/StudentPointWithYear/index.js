...
export default function StudentPointWithYear(props) {
    ...
    const CountStudentsWithYearAndExc = (year, students) => {
        ...
        students.map((student) => {
            if (student.schoolYear === year && student.point >= 8.5 && student.point <= 10) {
                sumExcWithYear++;
            }
        })
    ...
    const CountStudentsWithYearAndVeryGood = (year, students) => {
        ...
        students.map((student) => {
            if (student.schoolYear === year && student.point >= 8.0 && student.point <= 8.4) {
                sumVeryGoodWithYear++;
            }
        })
    ...
    const CountStudentsWithYearAndGood = (year, students) => {
        ...
        students.map((student) => {
            if (student.schoolYear === year && student.point >= 6.5 && student.point < 8) {
                sumGoodWithYear++;
            }
        })
    ...
    for (let yearIndex in years) {
        sumExcWithYear.push(CountStudentsWithYearAndExc(years[yearIndex], students));
        sumVeryGoodWithYear.push(CountStudentsWithYearAndVeryGood(years[yearIndex], students));
        sumGoodWithYear.push(CountStudentsWithYearAndGood(years[yearIndex], students));
        sumAverageWithYear.push(CountStudentsWithYearAndAverage(years[yearIndex], students))
        sumWeakWithYear.push(CountStudentsWithYearAndWeak(years[yearIndex], students))
    }
