...
export default function StudentsWithYear(props) {
    ...
    const { students, years, CountStudentsWithYearAndSex,sumStudentWithYear} = props;

    const sumMaleWithYear = [];
    for (let yearIndex in years) {
        sumMaleWithYear.push(CountStudentsWithYearAndSex(years[yearIndex], students, 'Nam'))
    }
